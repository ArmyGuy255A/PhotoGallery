...
{
    /// <inheritdoc />
    public partial class AddWorkerHeartbeatSqlServer : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastRanAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ItemsProcessedTotal = table.Column<long>(type: "bigint", nullable: false),
                    ItemsInFlight = table.Column<int>(type: "int", nullable: false),
